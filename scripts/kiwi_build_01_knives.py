...
def execute(output, selected):
    ...
    restored=run_tests()
    files=sorted({v[0] for v in MUTATIONS.values()}|{'Dockerfile','.github/workflows/ci.yml','scripts/test_kiwi_build_01.py','scripts/kiwi_build_01_knives.py'})
