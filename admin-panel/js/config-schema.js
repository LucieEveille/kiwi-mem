...
export const CONFIG_META = {
  ...
  reasoning_effort:       { label:'思考强度', type:'text', def:'off', input:'select', options:['off','auto','low','medium','high','xhigh','max'], desc:'转发时附带的推理强度，仅对支持 reasoning 的模型生效。off=不传，auto=由供应商自动决定。low/medium/high 是 OpenAI 系档位，xhigh/max 是 DeepSeek 系档位——供应商不认的档位会由供应商自己报错。（v1.6.1 新登记：此前面板上改不了）' },
